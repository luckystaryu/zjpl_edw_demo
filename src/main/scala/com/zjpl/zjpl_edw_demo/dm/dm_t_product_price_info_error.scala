...
object dm_t_product_price_info_error {
  ...
  def main(args: Array[String]): Unit = {
    ...
    sql(
      s"""
         ...
         |            ,concat_ws(',',case when isChineseCharacter(t1.city_cd)='1' or coalesce(t1.city_cd,'')=''
         |                                then 'E0004'
         |                                else null
         |                           end) as error_id
         |           from dm_db.dm_t_product_price_info_detail_error t1
